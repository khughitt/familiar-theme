...
- This is the contract package: it defines the theme protocol that the
  engine and forge (`familiar-forge`, private) repos consume as a git
  dependency. Treat its exported surface as the API — nothing outside
  `src/index.js`'s export is public.
